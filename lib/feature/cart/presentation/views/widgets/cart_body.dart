...
import 'package:shop_ecommerce/core/utils/lottie.dart';
        ...
        child: BlocBuilder<CartCubit, CartState>(builder: (context, state) {
          ...
          if (cartItems.isEmpty) {
            return Center(
              child: Column(
                children: [
                  Lottie.asset(LottieAssets.cartAsset),
                  const SizedBox(height: 20),
                  const Text(
                    "Your cart is empty!",
                    style: Styles.text24W600,
                  ),
                ],
              ),
            );
                  ...
                  itemBuilder: (context, index) {
                    return Padding(
                      ...
                      child: CustomShoppingItem(
                          shoppingDetailsBody:
                              CartShopItemBody(cartItemModel: cartItems[index]),
